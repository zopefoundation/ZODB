...
class ToBeDeleted(object):
    ...
    def __del__(self):
        global LP294788_ids
        #this might raise KeyError if the LP294788_ids dict is cleaned before
        #the object gets GC'ed, but this should not happen
        del LP294788_ids[self.id]
    ...
    def test_LP294788(self):
        ...
        for i in xrange(1024):
            if random.random() > 0.1:
                #add
                id = None
                while id is None or ids.has_key(id):
