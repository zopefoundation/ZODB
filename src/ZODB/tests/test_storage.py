...
# Ussed as base classes for test case
...
class MinimalTestSuite(StorageTestBase,
                       BasicStorage,
                       MTStorage,
                       SynchronizedStorage,
                       RevisionStorage,
...
def _makeStorage(just_klass=False):
