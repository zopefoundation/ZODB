# -*- coding: utf-8 -*-
#
# ZODB documentation build configuration file, created by
...
latex_documents = [
  ('index', 'ZODB.tex', u'ZODB Documentation',
...
man_pages = [
    ('index', 'zodb', u'ZODB Documentation',
...
texinfo_documents = [
  ('index', 'ZODB', u'ZODB Documentation',
   u'Zope Foundation Contributors', 'ZODB', 'One line description of project.',
   'Miscellaneous'),
]
